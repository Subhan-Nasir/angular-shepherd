...
export class ShepherdService {
    ...
    updateCurrentButtons(buttonsList: Shepherd.Step.StepOptionsButton[]) {
        this.tourObject.getCurrentStep().options.buttons = buttonsList;
    }
    ...
    addStepsToCurrentTour(steps: Array<Step.StepOptions>){
